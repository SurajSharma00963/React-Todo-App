...
import {View, Text,StyleSheet,KeyboardAvoidingView, TouchableOpacity, TextInput, TouchableOpacityBase} from 'react-native';
...
export default class AddListModal extends React.Component{
    backgroundColors=["#7FFF00","#008B8B","#8B008B","#808080","#20B2AA","#800000","#191970"]

    state={
        name :"",
        color:this.backgroundColors[2]
    };
        ...
        return(
            ...
            <View style={{alignSelf:'stretch', marginHorizontal:32}}>
                ...
                <TouchableOpacity style={[styles.create,{backgroundColor:this.state.color}]} onPress={this.createTodo}>
                    <Text style={{color:colors.white,fontWeight:"600",fontSize:16}}>Create</Text>
                </TouchableOpacity>
            </View>
